...
public class Vote {
    ...
    public Vote(
            String votingNode, Boolean voteValue, Boolean voteExchange, List<String> liveMembers,
    ...
    public String toString() {
        return "votingNode=" + votingNode + ", voteValue=" + voteValue + ", liveMembers=" + liveMembers + ", deadMembers= " + deadMembers;
    }
}
