...
public class MessageHandlerTest {
    ...
    public void cantAddNullHandler2() {
        MessageHandlerFactory.concurrentHandler(new TypedMessageHandler(FakeMessage.class, new FakeMessageHandler()),
                                                null,
    ...
    public void testMessageHandlerCombiner() {
        ...
        FakeMessageHandler h = new FakeMessageHandler();
        mi = MessageHandlerFactory.concurrentHandler(new TypedMessageHandler(FakeMessage.class, h),
    ...
    public void testMessageHandlerCombiner2levels() {
        ...
        MessageHandler mi1 = MessageHandlerFactory.concurrentHandler(new TypedMessageHandler(FakeMessage.class, h),
                                                                     new TypedMessageHandler(FakeMessage.class, h)
        );

        MessageHandler mi2 = MessageHandlerFactory.concurrentHandler(new TypedMessageHandler(FakeMessage.class, h),
                                                                     new TypedMessageHandler(FakeMessage.class, h)
        );
    ...
    public void testCombiningDefaultHandler() {
        MessageHandler mi = MessageHandlerFactory.concurrentHandler(MessageHandlerFactory.defaultHandler(),
                                                                    new TypedMessageHandler(FakeMessage.class,
